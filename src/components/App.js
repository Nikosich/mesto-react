  ...
  return (
    <CurrentUserContext.Provider value={currentUser}>
      ...
      <Header
        ...
        />
        <Routes>
          <Route path="/sign-up" element={<Register showInfoTooltip={handleShowInfoMessage}/>}></Route>
          <Route path="/sign-in" element={<Login showInfoTooltip={handleShowInfoMessage} onLogin={handleLogin} /> }></Route>
          <Route
            path="/"
            element={
